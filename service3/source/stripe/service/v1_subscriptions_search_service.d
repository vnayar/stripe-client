...
module stripe.service.v1_subscriptions_search_service;
...
/**
 * Service to make REST API calls to paths beginning with: /v1/subscriptions/search
 */
class V1SubscriptionsSearchService {
  static class GetSubscriptionsSearchParams {
    /**
   ...
   * India.</p>
   * See_Also: HTTP GET `/v1/subscriptions/search`
   */
  void getSubscriptionsSearch(
      GetSubscriptionsSearchParams params,
      GetSubscriptionsSearchResponseHandler responseHandler,
      ) {
