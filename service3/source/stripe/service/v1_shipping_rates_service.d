...
class V1ShippingRatesService {
  ...
  static class PostShippingRatesShippingRateTokenBody {
    /**
    ...
    static class FixedAmountUpdate {
      static class CurrencyOptionUpdate {
        @optional
        Nullable!(int) amount;
      ...
      @optional
      CurrencyOptionUpdate[string] currency_options;
  ...
  void postShippingRatesShippingRateToken(
      ...
      PostShippingRatesShippingRateTokenBody requestBody,
