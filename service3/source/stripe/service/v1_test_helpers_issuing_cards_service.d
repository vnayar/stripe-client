...
class V1TestHelpersIssuingCardsService {
  ...
  static class PostTestHelpersIssuingCardsCardShippingDeliverBody {
    /**
  ...
  void postTestHelpersIssuingCardsCardShippingDeliver(
      ...
      PostTestHelpersIssuingCardsCardShippingDeliverBody requestBody,
  ...
  static class PostTestHelpersIssuingCardsCardShippingReturnBody {
    /**
     * Specifies which fields in the response should be expanded.
     */
    @optional
  ...
  void postTestHelpersIssuingCardsCardShippingReturn(
      ...
      PostTestHelpersIssuingCardsCardShippingReturnBody requestBody,
  ...
  static class PostTestHelpersIssuingCardsCardShippingFailBody {
    /**
     * Specifies which fields in the response should be expanded.
     */
    @optional
  ...
  void postTestHelpersIssuingCardsCardShippingFail(
      ...
      PostTestHelpersIssuingCardsCardShippingFailBody requestBody,
  ...
  static class PostTestHelpersIssuingCardsCardShippingShipBody {
    /**
     * Specifies which fields in the response should be expanded.
     */
    @optional
  ...
  void postTestHelpersIssuingCardsCardShippingShip(
      ...
      PostTestHelpersIssuingCardsCardShippingShipBody requestBody,
