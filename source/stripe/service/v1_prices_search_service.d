...
module stripe.service.v1_prices_search_service;
...
/**
 * Service to make REST API calls to paths beginning with: /v1/prices/search
 */
class V1PricesSearchService {
  static class GetPricesSearchParams {
    /**
     ...
     * [query fields for prices](https://stripe.com/docs/search#query-fields-for-prices).
     */
    string query;

  }

  static class GetPricesSearchResponseHandler : ResponseHandler {
   ...
   * India.</p>
   * See_Also: HTTP GET `/v1/prices/search`
   */
  void getPricesSearch(
      GetPricesSearchParams params,
      GetPricesSearchResponseHandler responseHandler,
      ) {
