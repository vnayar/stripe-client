...
module stripe.service.v1_customers_search_service;
...
/**
 * Service to make REST API calls to paths beginning with: /v1/customers/search
 */
class V1CustomersSearchService {
  static class GetCustomersSearchParams {
    /**
     ...
     * [query fields for customers](https://stripe.com/docs/search#query-fields-for-customers).
     */
    string query;

  }

  static class GetCustomersSearchResponseHandler : ResponseHandler {
   ...
   * India.</p>
   * See_Also: HTTP GET `/v1/customers/search`
   */
  void getCustomersSearch(
      GetCustomersSearchParams params,
      GetCustomersSearchResponseHandler responseHandler,
      ) {
