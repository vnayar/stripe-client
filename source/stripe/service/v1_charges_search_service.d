...
module stripe.service.v1_charges_search_service;
...
/**
 * Service to make REST API calls to paths beginning with: /v1/charges/search
 */
class V1ChargesSearchService {
  static class GetChargesSearchParams {
    /**
     ...
     * [query fields for charges](https://stripe.com/docs/search#query-fields-for-charges).
     */
    Nullable!(Nullable!(string)) query;

  }

  static class GetChargesSearchResponseHandler : ResponseHandler {
   ...
   * India.</p>
   * See_Also: HTTP GET `/v1/charges/search`
   */
  void getChargesSearch(
      GetChargesSearchParams params,
      GetChargesSearchResponseHandler responseHandler,
      ) {
