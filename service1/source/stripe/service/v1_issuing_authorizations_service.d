...
class V1IssuingAuthorizationsService {
  ...
  static class PostIssuingAuthorizationsAuthorizationBody {
    /**
  ...
  void postIssuingAuthorizationsAuthorization(
      ...
      PostIssuingAuthorizationsAuthorizationBody requestBody,
  ...
  static class PostIssuingAuthorizationsAuthorizationDeclineBody {
    /**
     * Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an
     * object. This can be useful for storing additional information about the object in a
     * structured format. Individual keys can be unset by posting an empty value to them. All keys
  ...
  void postIssuingAuthorizationsAuthorizationDecline(
      ...
      PostIssuingAuthorizationsAuthorizationDeclineBody requestBody,
  ...
  static class PostIssuingAuthorizationsAuthorizationApproveBody {
    /**
     * Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an
     * object. This can be useful for storing additional information about the object in a
     * structured format. Individual keys can be unset by posting an empty value to them. All keys
    ...
    /**
     * If the authorization's `pending_request.is_amount_controllable` property is `true`, you may
  ...
  void postIssuingAuthorizationsAuthorizationApprove(
      ...
      PostIssuingAuthorizationsAuthorizationApproveBody requestBody,
