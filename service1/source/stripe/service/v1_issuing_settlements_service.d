...
module stripe.service.v1_issuing_settlements_service;
 ...
 */
class V1IssuingSettlementsService {
  static class GetIssuingSettlementsParams {
    /**
  ...
  static class GetIssuingSettlementsResponseHandler : ResponseHandler {
    ...
    static class IssuingSettlementList {
      /**
     ...
     * Successful response.
     */
    void delegate(IssuingSettlementList response) handleResponse200;
  ...
  static class GetIssuingSettlementsSettlementParams {
    /**
     * Specifies which fields in the response should be expanded.
     */
    string[] expand;
  ...
  static class GetIssuingSettlementsSettlementResponseHandler : ResponseHandler {
     ...
     * Successful response.
     */
    void delegate(IssuingSettlement response) handleResponse200;
  ...
  static class PostIssuingSettlementsSettlementBody {
    /**
  ...
  void postIssuingSettlementsSettlement(
      ...
      PostIssuingSettlementsSettlementBody requestBody,
